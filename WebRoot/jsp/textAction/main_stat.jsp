...
<script language="javascript">	
	...
	var flag=0;
	 ...
	 ListForm.action="textAction_delete.action";
...
<form name="ListForm" method="post" action="textAction_manageText.action" onSubmit="return ListForm_onclick();">
...
<TD>
        ...
        <a href="#" onclick="createXML()" ><image src="jsp/images/sign_05.gif" border="0"></a>

	      全选
	      <input type="checkbox" name="selectAllBox" onClick="selectAll()">

		<s:select list="#txtplates" onchange="selectPlate()" name="Cat" headerKey="" headerValue="请选择"/>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <table width="100%" border="1" cellspacing="0" cellpadding="2" class=font9  style="BORDER-bottom: #000000 2px solid;BORDER-top: #000000 2px solid;BORDER-left: #000000 1px solid;BORDER-right: #000000 1px solid;BACKGROUND-COLOR: #F6F6F6" bordercolor="#F6F6F6" >
	...
	<input type="checkbox" name="selCheck" value="${textID }" >               
        ...
        <td width="15%"><a href="javascript:void(0)" onClick="openWin('textAction_showText.action?textID=${textID}',650,500)">${textTitle}</a></td>	
	<td width="6%" >${rest1 }</td>	
