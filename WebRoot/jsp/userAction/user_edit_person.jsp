...
<s:hidden name="name_Login"></s:hidden>
            ...
            <div class="field">
                <div class="four fields">
                    ...
                    <div class="field" >
                        <label>省（直辖市）<i class="red check square icon"></i></label>
                     ...
                     <div class="field" >
                        <label>市（地区）<i class="red check square icon"></i></label>
                     ...
                     <div class="field" >
                        <label>县（区）<i class="red check square icon"></i></label>
                ...
                <div class="two fields">
                    ...
                    <div class="field">
                        ...
                        <input name="bankaddress" maxlength="50" placeholder="开户行准确名称" type="text"
                               value="${bankaddress}" placeholder="XX银行XX支行">
                    </div>
