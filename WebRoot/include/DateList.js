...
var ctrlValue = "";
function fPopCalendar(popCtrl, dateCtrl, frmUpdate){
  frm1 = frmUpdate;
  ctrlValue = dateCtrl.value;
...
function fSetDate(iYear, iMonth, iDay){
  ...
  fHideCalendar();
 // if (ctrlValue != gdCtrl.value)
 // {
 // 	TextDateOnChange(frm1);
 // }
...
write("<B style='cursor:hand;font:bold 16宋体' onclick='fSetDate(giYear,giMonth,giDay)' onMouseOver='this.style.color=gcToggle' onMouseOut='this.style.color=0'>今天"+giYear+"年"+giMonth+"月"+giDay+"日</B>");
write("</TD></TR>");
write("</TABLE></Div>");
