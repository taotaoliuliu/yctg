...
<script language="javascript">
	...
	function zhuzhuang(obj){
		...
		var jianbao= $("input[name='jianbao']:checked").val();
...
document.location.href="textAction_textStatusBaoBiao.action?StartDate="+ss+"&EndDate="+ee+"&LimitSetTime="+ff+"&jianbao="+jianbao;
...
document.location.href="textAction_textStatusByCounty.action?StartDate="+ss+"&EndDate="+ee+"&LimitSetTime="+ff+"&jianbao="+jianbao;
...
<form name="Status" method="post" action="textAction_textStatusZZ2.action">
...
<input type="radio" name="jianbao" value="CMA" <%if("0".equals(jianbao)){%>checked  <%}%> /> CMA网站
<input type="radio" name="jianbao" value="ZGQXB" <%if("1".equals(jianbao)){%>checked  <%}%> /> 中国气象报
