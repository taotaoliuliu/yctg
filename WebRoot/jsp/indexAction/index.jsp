    ...
    <div class="column">
        <div class="ui main container">
            ...
            <div class="ui centered header">
                <a href="textAction_statPerson.action" class="ui blue big button">进入投稿区</a>
                
                <c:if test="${user!=null&&user.role=='管理员' }"><a href=\"/Article\" class=\"ui blue big button\">进入管理区</a></c:if>
            </div>
