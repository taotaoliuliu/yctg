...
<Table border=0 width=100% cellpadding="0" cellspacing="0">
    ...
    &nbsp;&nbsp;
   <h5> <b>::&nbsp;&nbsp;未审核的用户管理--修改（${name_real }）用户信息&nbsp;&nbsp;::</b></h5><br>
   ...
   <table width="100%" border="0" cellspacing="0" cellpadding="0" height="0">     
     ...
     <select id="s1" name="province"><option>请选择</option></select><font color=red>*</font>
      ...
      <tr>
        ...
        <td width="25%" align="left"><s:select cssClass="input0" cssStyle="width:132" name="role"  list="{'记者','通讯员','统计员','管理员'}" 
       ...
       <tr>
        ...
        <td  width="15%" align="left">开户行准确名称：</td>
...
<br><br>
	      <table width="90%" border="0" cellspacing="0" cellpadding="0">
	        <tr> 
	          <td width="97%" align="center"><input type="image" src="jsp/images/queren.gif" width="69" height="20" border="0">　<a href="userAction_auditingList.action"><img src="jsp/images/cancel.gif" width="69" height="20" border="0"></a></td> 
	        </tr>
	      </table>
