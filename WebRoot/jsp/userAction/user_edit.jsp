   ...
   <table width="100%" border="0" cellspacing="0" cellpadding="0" height="0">     
      ...
      <tr>
       <td width="15%" align="left" height="30">用户真实名：</td>
        <td width="45%" align="left"> <s:textfield  name="name_real"  id="cnname"  cssClass="input0"/>  
      ...
      <tr>
		...
		<s:select cssClass="input0" cssStyle="width:132" name="role"  list="{'记者','通讯员','统计员','管理员','普通用户'}" 
        ...
        <td  width="15%" align="left">开户行准确名称：（XX银行XX支行）</td>
        <td  width="25%" align="left"><input type="text" name="bankaddress" value="${ bankaddress}" class="input0" placeholder="XX银行XX支行"> <font color=red>*</font></td>     	
      </tr> 	  
      ...
      <tr>
        ...
        <td>
          <s:password name="password" cssStyle="input0"/> 如不填，则不更改用户密码        </td>
