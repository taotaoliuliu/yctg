...
<Table border=0 width=100% cellpadding="0" cellspacing="0">
    ...
    &nbsp;&nbsp;
  <h5>  <b>::&nbsp;&nbsp;未审核的用户管理--查看（${name_real }）用户信息&nbsp;&nbsp;::</b></h5><br>
            <hr width="100%" size="1" noshade>
          </td>
        </tr>
</Table>

<s:form name="UpdateForm" method="post" action="userAction_editAuditingRe.action" onsubmit="return UpdateForm_onclick();">
...
<s:hidden name="password"></s:hidden>
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <LEGEND align=left><B>：用户信息</B> </LEGEND>
   ...
   <table width="100%" border="0" cellspacing="0" cellpadding="0" height="0">     
      ...
      <tr>
       <td width="15%" align="left" height="30">用户真实名：</td>
        <td width="45%" align="left"> <s:textfield  name="name_real"  id="cnname"  cssClass="input0" readonly="true"/>   <font color=red>*</font></td>
      ...
      <tr>
        ...
        <td width="45%" align="left"><select name="province"  onChange="select()" style="width:132" ></select> <font color=red>*</font></td>
      	<td width="15%" align="left">用户所属市：</td>
        <td width="25%" align="left"><select name="city" width="61%" onChange= "select()" style="width:132"></select> <font color=red>*</font></td>
      </tr>
      ...
      <tr>
        ...
        <td width="25%" align="left"><s:select cssClass="input0" cssStyle="width:132" name="role"  list="{'通讯员','统计员','管理员'}" 
      ...
      <tr>
       ...
       <tr>
        <td width="15%" align="left" height="34">家庭电话：</td>
      ...
      <tr>
	   <tr>
        ...
        <td width="15%" align="left" height="30">用户所属单位：</td>
        <td width="45%" align="left"><s:select list="#workcompanys" name="workcompany"></s:select>
...
<br><br>
	      <table width="90%" border="0" cellspacing="0" cellpadding="0">
	        <tr> 
 <td width="97%" align="center">　<a href="userAction_auditingList.action"><img src="jsp/images/goBack.png" width="50" height="20" border="0"></a></td> 
