...
<div class="ui main column grid container">
    <div class="column">
        ...
        <div class="text container">
            <div class="ui segment">
                <a href="textAction_statPerson.action" class="ui blue button" style="margin-top: 4px;">返回稿件列表</a>
                <a href="textAction_textContribute.action" class="ui blue button" style="margin-top: 4px;">图文投稿</a>
                
                <a href="textAction_textContribute2.action" class="ui blue button" style="margin-top: 4px;">视频投稿</a>
            </div>
        </div>
        ...
        <input type="hidden" name="mytype" value="4">
            <h3 class="ui dividing green header" style="margin-top: 1em; ">音频投稿</h3>
            ...
            <div class="field">
                <div class="four fields">
                    ...
                    <div class="field">
                        <label>作者</label>
                        <input name="author" readonly="readonly" maxlength="11" placeholder="作者" type="text" value="${user.name_real }">
                    </div>
                </div>
            </div>
            ...
            <div class="inline fields">
                ...
                <div class="field">
                    <div class="ui radio checkbox">
                        <input class="hidden" tabindex="0" name="Cat" checked="" type="radio">
                        <label> 全部</label>
                    </div>
                </div>
                <div class="field">
            ...
            <h4 class="ui green dividing header">音频附件</h4>
    ...
    <div class="ui action input">
        ...
        <label for="uploadImages" class="ui icon button btn-file1">
               <i class="file icon"></i>选择文件
             <input type="file" id="uploadImages" name="uploadImages" style="display: none">
        </label>
    </div>
	</div>  
	</div>
