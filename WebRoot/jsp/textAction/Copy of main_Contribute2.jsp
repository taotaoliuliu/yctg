...
function CheckFileExt(strFullfilepath)
	{
			...
			if( fileExtension!= "flv"&& fileExtension!= "avi"&& fileExtension!= "mp4"&& fileExtension!= "3gp")
			{					
				alert('请选择flv/avi/mp4/3gp格式的视频文件！');
				//return false;	
			}
			//else
			//{
...
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
  ...
  <TR align="center">
    ...
    <TD width="25%" class=text><B><h4><A 
      href="textAction_statPerson.action">::&nbsp;${name }的上传稿件统计&nbsp;::</A></B></h4><BR>
      <HR width="100%" noShade SIZE=1>
  </TD></TR></TBODY></TABLE>
...
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
  ...
  <TR>
    <TD vAlign=top align=middle bgColor=#ffffff height=250>
      ...
      <LEGEND align=left><B>视频稿件：</B> </LEGEND>
      <TABLE cellSpacing=0 cellPadding=0 width="95%" align=center border=0>
        ...
        <TR>
          <TD height=30 colspan="2"><BR>
			...
			作者：
			<input type="text" name=author value="${name }" class="input0" style="width:80pt "><font color="#FF0000">多个作者请请用逗号隔开</font><BR>    
			<BR>
			...
			<BR>    <BR>
			视频附件：<input type="button" value="增加附件" onClick="AddMore()"><font color="#FF0000">附件flv格式；单个附件大小请限定在10M以内，建议上传三个以内的附件以防上传失败</font>
			<div id="file_d">
                        </div>
...
<tr> 
<td width="97%" align="center"><input type="image" src="images/queren.gif" width="69" height="20" border="0">   <a href="textAction_textContribute2.action"><img src="images/cancel.gif" width="69" height="20" border="0"></a></td>
</tr>							
</table>
