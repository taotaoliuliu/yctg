...
{	
	...
	//window.open("userAction_changePassword.action","","height=900,width=900");
	//changePassWin();
}
</SCRIPT>
      ...
      border=0>
        ...
        <TR>
          ...
          <A class=toplink 
            ...
            target=uniMain>管理区</A> 
            <FONT color=#898989>| 
            
            </FONT>
            
            <A class=toplink href="textAction_manageText.action" 
            target=uniMain>稿件管理区</A> 
            <FONT color=#898989>| 
            
            </FONT>
            <A class=toplink href="bulletinAction_home.action" 
			...
			<A class="toplink"
            onclick="javascript:changePasswd()" 
            href="javascript:void(0)">修改口令</A> 
            
            <FONT 
            color="#898989">| </FONT>
            
            <A class=toplink 
            href="userAction_logout.action" target=_top>退 出</A> 
