...
<div class="ui middle aligned center aligned grid" style="margin-top: 2em;">
    <div class="column" style="max-width: 450px;">
            ...
            <div class="ui stacked segment">
                <div class="field">
                    <div class="ui left icon input">
                        <i class="user icon"></i>
                        <input type="text" name="name_Login" placeholder="用户名">
                    </div>
                </div>
                <div class="field">
                    <div class="ui left icon input">
        ...
        <div class="ui equal width grid" style="padding: 2em;">
            <div class="column"><a href="userAction_createPerson" class="ui teal button">注册新用户</a></div>
            <div class="column"><a href="userAction_findPassword" class="ui orange button">忘记密码</a></div>
        </div>
    </div>
</div>
